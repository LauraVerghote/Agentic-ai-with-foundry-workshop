...
In this sub-lab, you'll create an AI agent in Microsoft Foundry that uses your vector index to answer questions. The agent combines your chat model (e.g., GPT-5.4-mini) with your indexed documents to provide accurate, context-aware responses.
...
5. Select a chat completions model: `gpt-5.4-mini` (or `gpt-4.1-mini`, `gpt-4.1` if you deployed a different model in Sub-Lab 1.1)
