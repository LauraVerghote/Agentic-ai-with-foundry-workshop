...
- A knowledge base powered by File search and vector stores
...
- Use File search to create a vector store for grounded answers
...
| [Lab 2: Prepare Knowledge Base Documents](./lab-2-create-knowledge-base.md) | Review sample documents for the agent | 5-10 min |
