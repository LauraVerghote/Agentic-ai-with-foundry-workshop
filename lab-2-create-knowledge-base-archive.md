...
3. Configure:
   ...
   On the **Networking** tab, make sure **Network access** is set to **Enable public access from all networks** (this is the default).
...
2. A "Create a knowledge source" dialog appears:
   ...
   - **Storage account**: Select `stfoundryws[yourname]`
